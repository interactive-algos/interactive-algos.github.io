 ...
 * @constructor
 * @param {number} a1 - Rotational noise from rotation
 * @param {number} a2 - Rotational noise from translation
 * @param {number} a3 - Translational error from translation
 * @param {number} a4 - Translational error from rotation
 */
